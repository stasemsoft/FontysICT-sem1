...
- Major README.md improvements:
  - Added Quick Start section with Visual Studio installation link
  - Completely rewrote and improved English throughout (fixed awkward AI translations from earlier)
  - Fixed typos: "decennia" → "decades", removed double spaces, fixed punctuation
  - Renamed "finally" section to "Additional Resources"
  - Changed "Parts" to "Learning Content" for clarity
  - Standardized all bullet formatting to use `-` consistently
  - Improved descriptions and clarity throughout
  - Better structured layout and flow
...
[Originals in Dutch](https://stasemsoft.github.io/softwarematerial/)
